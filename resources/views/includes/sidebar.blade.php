        ...
        <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
						<div class="menu_section">
							...
							<ul class="nav side-menu">
								<li><a><i class="fa fa-users"></i> Users <span class="menu-arrow"></span></a>
								...
								<li><a><i class="fa fa-edit"></i> Categories <span class="fa fa-chevron-down"></span></a>
									<ul class="nav child_menu">
										<li><a href="{{route('addcat')}}">Add Category</a></li>
										<li><a href="{{route('cat')}}">Categories List</a></li>
									</ul>
								</li>
                ...
                <li><a><i class="fa fa-desktop"></i> Testimonials <span class="fa fa-chevron-down"></span></a>
									<ul class="nav child_menu">
										<li><a href="addtestimonial.html">Add Testimonials</a></li>
										<li><a href="edittestimonial.html">Edit Testimonials</a></li>
									</ul>
								</li>
