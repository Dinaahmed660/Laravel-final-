								...
								<div class="x_content">
									...
									<form action="{{route('storeCar')}}" method="post" enctype="multipart/form-data" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input id="doors" class="form-control" type="number" name="Doors" required="required">											</div>
												@error('Doors')
													{{ $message }}
												@enderror
											</div>
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input id="Passangers" class="form-control" type="number" name="Passangers" required="required">												
												@error('Passangers')
													{{ $message }}
												@enderror
											</div>
