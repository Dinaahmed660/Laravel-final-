									...
									<form action="{{ route('updateCar',$car->id) }}" method="post" enctype="multipart/form-data" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" name="Title" id="title" required="required" class="form-control "value="{{ $car->Title }}">
												@error('Title')
													{{ $message }}
												@enderror
											</div>
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<textarea id="content" name="Content" required="required" class="form-control" {{ $car->Content }}>Contents</textarea>
												@error('Content')
													{{ $message }}
												@enderror
											</div>
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input id="passengers" class="form-control" type="number" name="Passengers" value="{{ $car->Passangers }}" required="required">
												@error('Passangers')
													{{ $message }}
												@enderror
											</div>
